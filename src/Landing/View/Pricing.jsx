...
const Pricing = () => {
    ...
    //     console.log('Button clicked'); // Check if the function is fired
    //     // navigate('../../Landing/View/ContactForm');
    //     navigate('../Landing/View/ContactForm');

    // };
    const navigate = useNavigate();

    const price = "83,315.13";

    const handleButtonClick = () => {
        // alert('Button clicked!');
        
        navigate('/ContactForm', {state: {price : price }})
       
        // You can also perform any logic here (e.g., API call, update state)
      };
            ...
            <div>
                ...
                <div className="page-content">
                    ...
                    <section className="content-inner pricing-plan-wrapper bg-primary-light">
                        <img className="bg-shape2" src="images/home-banner/shape1.png" alt />
                        <img className="bg-shape3" src="images/home-banner/shape1.png" alt />
                        <img className="bg-shape1" src="images/home-banner/shape3.png" alt />
                        <img className="bg-shape4" src="images/home-banner/shape3.png" alt />
                        <img className="bg-shape5" src="images/home-banner/shape3.png" alt />
                        <div className="container">
                            <div className="section-head text-center">
                                <h2 className="title">Awesome Pricing Plan for Cryptocurrency Sip</h2>
                            </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6 m-b30">
                                    <div className="pricingtable-wrapper box-hover style-1">
                                        <div className="pricingtable-inner">
                                            ...
                                            <p>Most valueable Crypto Coin</p>
                                            <div className="pricingtable-price">
                                                <h2 className="pricingtable-bx text-primary"> <span>Rs.</span>83,315.13</h2>
                                                <div> 
                                                    <button className="days-label bg-primary" onClick={handleButtonClick} >BUY</button>
                                                    </div>
                                            </div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6 m-b30">
                                    <div className="pricingtable-wrapper box-hover style-1">
                                        <div className="pricingtable-inner">
                                            ...
                                            <div className="pricingtable-price">
                                                <h2 className="pricingtable-bx text-primary"> <span>Rs.</span>128.947</h2>
                                                <div className="days-label bg-primary" onClick={handleButtonClick}>BUY</div>
                                ...
                                <div className="col-xl-4 col-lg-6 col-md-6 m-b30">
                                    <div className="pricingtable-wrapper box-hover style-1 active">
                                        <div className="pricingtable-inner">
                                            ...
                                            <p>Buy</p>
                                            <div className="pricingtable-price">
                                                <h2 className="pricingtable-bx text-primary"> <span>Rs.</span>1896.03</h2>
                                                <div className="days-label bg-primary">BUY</div>
